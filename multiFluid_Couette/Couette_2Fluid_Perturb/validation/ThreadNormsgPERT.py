...
Xthreads1 = np.genfromtxt("gPERT_1Thread/xprof")
Xthreads4 = np.genfromtxt("gPERT_4Threads/xprof")
XdiffArr = []
...
Ythreads1 = np.genfromtxt("gPERT_1Thread/yprof")
Ythreads4 = np.genfromtxt("gPERT_4Threads/yprof")
unique = []
