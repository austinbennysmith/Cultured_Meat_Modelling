...
# logstats1 = np.genfromtxt('PERT_1Thread/logstats.dat', delimiter=' ', comments=None)
# logstats4 = np.genfromtxt('PERT_4Threads/logstats.dat', delimiter=' ', comments=None)
logstats1 = np.genfromtxt('PERT_4Threads/logstats.dat', delimiter=' ', comments=None)
logstats4 = np.genfromtxt('PERT_4ThreadsAd/logstats.dat', delimiter=' ', comments=None)
