...
Xthreads1 = np.genfromtxt("PERT_1Thread/xprof")
Xthreads4 = np.genfromtxt("PERT_4Threads/xprof")
XdiffArr = []
...
Ythreads1 = np.genfromtxt("PERT_1Thread/yprof")
Ythreads4 = np.genfromtxt("PERT_4Threads/yprof")
unique = []
