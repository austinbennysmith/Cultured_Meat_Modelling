...
logstats1 = np.genfromtxt('1Thread/multicouette/logstats.dat', delimiter=' ', comments=None)
logstats4 = np.genfromtxt('4Thread/multicouette/logstats.dat', delimiter=' ', comments=None)
