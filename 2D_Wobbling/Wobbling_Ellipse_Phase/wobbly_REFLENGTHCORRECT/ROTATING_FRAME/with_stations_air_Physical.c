...
#define dimensional_period 1.0 // # of seconds to go throug a complete oscillation
...
#define refVelocity ((refLength*maxRads)/dimensional_period)  // Reference length, defined in terms of the Froude number

#define period dimensional_period/(refLength/refVelocity) // how many NONDIMENSIONAL/SIMULATION seconds it takes to go through a complete rocking cycle
#define BB (2.0*3.14159265)/period
...
#define Fr (refVelocity/sqrt(9.8*0.03)) // Froude number, 0.03 is the semimajor axis in m
