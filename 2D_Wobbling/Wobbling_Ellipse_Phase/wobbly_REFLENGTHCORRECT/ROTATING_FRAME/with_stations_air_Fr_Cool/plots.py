...
# #define refVelocity (refLength*period/maxRads)  // Reference length, defined in terms of the Froude number
# 
# #define Fr refVelocity/sqrt(9.8*(refLength*3.0)) // Froude number
# 
